...
public class DgfoodDealerWorkflowHandlerUtil {
	private static Log log = LogFactoryUtil.getLog(DgfoodDealerWorkflowHandlerUtil.class);
	...
	public static String getWorkflowCurrentTaskCommentsByWorkflowInstanceIdAndNodeId(long workflowInstanceId, long companyId, String nodeId) {
