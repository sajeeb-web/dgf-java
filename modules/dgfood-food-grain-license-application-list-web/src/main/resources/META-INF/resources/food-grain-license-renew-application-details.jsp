...
<portlet:actionURL name="approvedLicense" var="approvedRenewLicenseURL">
...
<portlet:renderURL var="renderRenewURL"></portlet:renderURL>
...
<title>Food Grain License Renew Application Details</title>
</head>
...
<body>
	<div class="container main-div">
		...
		<div class="d-flex justify-content-between">
			<span class=" fw-bold p-0 m-0"> <!-- Food Grain License Renewal Application details -->
				<liferay-ui:message
					key="food-grain-license-renewal-application-details" />

			</span> <span class=" fw-bold p-0 m-0"> <!-- Last Login:  --> <liferay-ui:message
		...
		<div class="container">
			<div class="card py-4 px-2">
					...
					<div class="col-md-5 col-sm-12">
						<ul class="alignMe">
							<li><span class="custom-colon"> <!-- Marital Status -->
									...
									test="${not empty detailedDataList}"><liferay-ui:message
										key="<%=detailedDataList.get("maritalStatus").toString().toLowerCase()%>" /></c:if></li>
				...
				<div class="row px-2 justify-content-between">
					...
					<div class="col-md-5 col-sm-12">
						<ul class="alignMe">
							...
							</span> <c:if test="${not empty detailedDataList}"><%=detailedDataList.get("bin")%></c:if></li>
				...
				<h5 class="green-text fw-bold mb-0 mt-2">
					<!-- Renew License Info -->
					<liferay-ui:message key="renew-license-info" />
				</h5>
				<div class="green-bg">
					<hr class="mt-0 mb-0" />
				</div>
					...
					<div class="col-md-5 col-sm-12">
						<ul class="alignMe">
							<li><span class="custom-colon"> <!-- Comments --> <liferay-ui:message
										key="renew-license-comments" /></span> <c:if
									test="${not empty detailedDataList}"><%=detailedDataList.get("fglLicenseRenewComment")%></c:if></li>
				...
				<div class="row justify-content-between px-2 pt-2 div">
					<div
						...
						<span class="px-md-5 px-sm-1"><c:if
								...
								<a class="text-decoration-none
									font-italic"
									href="<%=detailedDataList.get("renewPaymentAttchDocument")%>"
					...
					<div
						...
						<span class="px-md-5 px-sm-1"><c:if
								...
								<a class="text-decoration-none font-italic"
									href="<%=detailedDataList.get("renewTradeAttchDocument")%>"
									target="_blank"><mark class="mark ">
										<liferay-ui:message key="view" />
										<i class="icon-file-text ms-1 ps-1 h6 text-primary"></i>
									</mark></a>
				...
				<div class="mt-3 px-2">
					...
					<a href="<%=renderRenewURL%>" class="btn btn-reset me-2"> <i
				...
				<div id="approved-comments-popup" style="display: none !important"
					...
					<div class="position-relative">
						<div class="p-2 text-center">
							<div class="mt-4">
								<aui:form action="${approvedRenewLicenseURL}"
