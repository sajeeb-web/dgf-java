...
/**
 * Provides the local service interface for DlrFfpOmsAllcNtfyDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DlrFfpOmsAllcNtfyDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DlrFfpOmsAllcNtfyDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.friendly.program.service.impl.DlrFfpOmsAllcNtfyDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dlr ffp oms allc ntfy details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DlrFfpOmsAllcNtfyDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DlrFfpOmsAllcNtfyDetails addDlrFfpOmsAllcNtfyDetails(
	...
	public DlrFfpOmsAllcNtfyDetails createDlrFfpOmsAllcNtfyDetails(
		String allocNtfyId);
	...
	public DlrFfpOmsAllcNtfyDetails deleteDlrFfpOmsAllcNtfyDetails(
		DlrFfpOmsAllcNtfyDetails dlrFfpOmsAllcNtfyDetails);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DlrFfpOmsAllcNtfyDetails fetchDlrFfpOmsAllcNtfyDetails(
		String allocNtfyId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DlrFfpOmsAllcNtfyDetails getDlrFfpOmsAllcNtfyDetails(
			String allocNtfyId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DlrFfpOmsAllcNtfyDetails> getDlrFfpOmsAllcNtfyDetailses(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DlrFfpOmsAllcNtfyDetails updateDlrFfpOmsAllcNtfyDetails(
		DlrFfpOmsAllcNtfyDetails dlrFfpOmsAllcNtfyDetails);
