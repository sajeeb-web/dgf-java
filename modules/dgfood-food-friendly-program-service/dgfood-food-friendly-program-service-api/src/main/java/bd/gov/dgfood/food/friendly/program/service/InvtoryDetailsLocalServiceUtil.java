...
/**
 * Provides the local service utility for InvtoryDetails. This utility wraps
 * <code>bd.gov.dgfood.food.friendly.program.service.impl.InvtoryDetailsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class InvtoryDetailsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.friendly.program.service.impl.InvtoryDetailsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static InvtoryDetails addInvtoryDetails(
		InvtoryDetails invtoryDetails) {

		return getService().addInvtoryDetails(invtoryDetails);
	}
	 ...
	 */
	public static InvtoryDetails createInvtoryDetails(long inventoryId) {
		return getService().createInvtoryDetails(inventoryId);
	}
	 ...
	 */
	public static InvtoryDetails deleteInvtoryDetails(
		InvtoryDetails invtoryDetails) {

		return getService().deleteInvtoryDetails(invtoryDetails);
	}
	 ...
	 */
	public static InvtoryDetails deleteInvtoryDetails(long inventoryId)
		throws PortalException {

		return getService().deleteInvtoryDetails(inventoryId);
	}
	...
	public static InvtoryDetails fetchInvtoryDetails(long inventoryId) {
		return getService().fetchInvtoryDetails(inventoryId);
	}
	 ...
	 * @throws PortalException if a invtory details with the primary key could not be found
	 */
	public static InvtoryDetails getInvtoryDetails(long inventoryId)
		throws PortalException {

		return getService().getInvtoryDetails(inventoryId);
	}
	 ...
	 */
	public static List<InvtoryDetails> getInvtoryDetailses(int start, int end) {
		return getService().getInvtoryDetailses(start, end);
	}
	 ...
	 */
	public static int getInvtoryDetailsesCount() {
		return getService().getInvtoryDetailsesCount();
	}
	 ...
	 */
	public static InvtoryDetails updateInvtoryDetails(
		InvtoryDetails invtoryDetails) {

		return getService().updateInvtoryDetails(invtoryDetails);
	}

	public static InvtoryDetailsLocalService getService() {
		return _service;
	}

	private static volatile InvtoryDetailsLocalService _service;
