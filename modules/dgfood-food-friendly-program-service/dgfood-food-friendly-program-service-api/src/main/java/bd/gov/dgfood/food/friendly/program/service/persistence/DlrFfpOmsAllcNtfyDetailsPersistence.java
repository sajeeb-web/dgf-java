...
/**
 * The persistence interface for the dlr ffp oms allc ntfy details service.
 *
 * <p>
 ...
 * @see DlrFfpOmsAllcNtfyDetailsUtil
 * @generated
 */
@ProviderType
public interface DlrFfpOmsAllcNtfyDetailsPersistence
	extends BasePersistence<DlrFfpOmsAllcNtfyDetails> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DlrFfpOmsAllcNtfyDetailsUtil} to access the dlr ffp oms allc ntfy details persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	...
	public void cacheResult(
		java.util.List<DlrFfpOmsAllcNtfyDetails> dlrFfpOmsAllcNtfyDetailses);
	 ...
	 */
	public java.util.List<DlrFfpOmsAllcNtfyDetails> findAll();
	 ...
	 */
	public java.util.List<DlrFfpOmsAllcNtfyDetails> findAll(int start, int end);
	...
	public java.util.List<DlrFfpOmsAllcNtfyDetails> findAll(
		...
		com.liferay.portal.kernel.util.OrderByComparator
			<DlrFfpOmsAllcNtfyDetails> orderByComparator);
