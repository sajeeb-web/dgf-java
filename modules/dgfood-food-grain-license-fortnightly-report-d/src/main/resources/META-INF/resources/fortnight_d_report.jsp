        	...
        	<div class=" my-2">
				...
				<hr class="mt-0 mb-1" />
					<div class="d-flex justify-content-between">
						<span class=" fw-bold p-0 m-0"> <liferay-ui:message key="fortnightly-report-form-gha"/></span> <span
				...
				<portlet:renderURL var="searchActionURL"  />
				    ...
				    <div class="row p-1">
				        <div class="col-md-3 col-sm-6">
				            <label class="fw-bold text14 mb-1"><liferay-ui:message
								key="license-type" /> </label>
				            <aui:select id="lc_type" class="form-select w-100" aria-label="Default select example" name="licenseType" label="">
						...
						<c:if test="${isDcf == true }">
							<div class="col-md-3 col-sm-6">
					           <label class="fw-bold text14 mb-1"><liferay-ui:message key="upzilla" /></label>
					            ...
					            <aui:select id="upazilla" class="form-select w-100" aria-label="Default select example" name="subdistrict" label="">
				        ...
				        <div class="col-md-3 col-sm-6">
				          <label class="fw-bold text14 mb-1"><liferay-ui:message key="union" /></label>
				            <aui:select id="union" class="form-select w-100" aria-label="Default select example" name="union" label="">
