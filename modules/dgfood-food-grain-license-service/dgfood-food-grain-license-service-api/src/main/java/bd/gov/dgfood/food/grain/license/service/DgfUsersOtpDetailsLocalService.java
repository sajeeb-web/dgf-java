...
/**
 * Provides the local service interface for DgfUsersOtpDetails. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DgfUsersOtpDetailsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DgfUsersOtpDetailsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersOtpDetailsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf users otp details local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DgfUsersOtpDetailsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DgfUsersOtpDetails addDgfUsersOtpDetailsByNidAndMobileAndUser(
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsersOtpDetails> getDgfUsersOtpDetailses(int start, int end);
	...
	public DgfUsersOtpDetails verifyDgfUsersOtpDetailsByOtpAndOtpIdAndMobile(
