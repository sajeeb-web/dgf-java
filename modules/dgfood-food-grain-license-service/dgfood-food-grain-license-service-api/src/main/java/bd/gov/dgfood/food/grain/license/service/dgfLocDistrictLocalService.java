...
/**
 * Provides the local service interface for dgfLocDistrict. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see dgfLocDistrictLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface dgfLocDistrictLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.dgfLocDistrictLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf loc district local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link dgfLocDistrictLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public dgfLocDistrict adddgfLocDistrict(dgfLocDistrict dgfLocDistrict);
	...
	public dgfLocDistrict createdgfLocDistrict(long id);
	...
	public dgfLocDistrict deletedgfLocDistrict(dgfLocDistrict dgfLocDistrict);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public dgfLocDistrict deletedgfLocDistrict(long id) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public dgfLocDistrict fetchdgfLocDistrict(long id);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public dgfLocDistrict getdgfLocDistrict(long id) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<dgfLocDistrict> getdgfLocDistricts(int start, int end);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<dgfLocDistrict> getdivWiseDis(long divId);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public dgfLocDistrict updatedgfLocDistrict(dgfLocDistrict dgfLocDistrict);
