...
import bd.gov.dgfood.food.grain.license.exception.NoSuchDgfUsersForthnightReportDException;
...
/**
 * The persistence interface for the dgf users forthnight report d service.
 *
 * <p>
 ...
 * @see DgfUsersForthnightReportDUtil
 * @generated
 */
@ProviderType
public interface DgfUsersForthnightReportDPersistence
	extends BasePersistence<DgfUsersForthnightReportD> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link DgfUsersForthnightReportDUtil} to access the dgf users forthnight report d persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
	 */
	 ...
	 */
	public java.util.List<DgfUsersForthnightReportD>
	...
	public java.util.List<DgfUsersForthnightReportD>
		findByDgfUsersForthnightReportDByUsernationalId(
			...
			com.liferay.portal.kernel.util.OrderByComparator
				<DgfUsersForthnightReportD> orderByComparator);
	 ...
	 */
	public DgfUsersForthnightReportD
			findByDgfUsersForthnightReportDByUsernationalId_First(
				String usernationalId,
				com.liferay.portal.kernel.util.OrderByComparator
					<DgfUsersForthnightReportD> orderByComparator)
		throws NoSuchDgfUsersForthnightReportDException;
	 ...
	 * @param usernationalId the usernational ID
	 */
	public void removeByDgfUsersForthnightReportDByUsernationalId(
		String usernationalId);
	 ...
	 */
	public int countByDgfUsersForthnightReportDByUsernationalId(
		String usernationalId);
	 ...
	 * @param screenName the screen name
	 */
	public void removeByDgfUsersForthnightReportDByScreenName(
		String screenName);
	 ...
	 * @return the number of matching dgf users forthnight report ds
	 */
	public int countByDgfUsersForthnightReportDByScreenName(String screenName);
	 ...
	 */
	public void cacheResult(
		java.util.List<DgfUsersForthnightReportD> dgfUsersForthnightReportDs);
	 ...
	 */
	public DgfUsersForthnightReportD create(long reportId);
	 ...
	 * @throws NoSuchDgfUsersForthnightReportDException if a dgf users forthnight report d with the primary key could not be found
	 */
	public DgfUsersForthnightReportD remove(long reportId)
		throws NoSuchDgfUsersForthnightReportDException;

	public DgfUsersForthnightReportD updateImpl(
		DgfUsersForthnightReportD dgfUsersForthnightReportD);
	 ...
	 * @throws NoSuchDgfUsersForthnightReportDException if a dgf users forthnight report d with the primary key could not be found
	 */
	public DgfUsersForthnightReportD findByPrimaryKey(long reportId)
		throws NoSuchDgfUsersForthnightReportDException;
	 ...
	 */
	public DgfUsersForthnightReportD fetchByPrimaryKey(long reportId);
	 ...
	 */
	public java.util.List<DgfUsersForthnightReportD> findAll();
