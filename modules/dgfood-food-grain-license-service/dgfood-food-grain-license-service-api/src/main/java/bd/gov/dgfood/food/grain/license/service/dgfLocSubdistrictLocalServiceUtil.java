...
/**
 * Provides the local service utility for dgfLocSubdistrict. This utility wraps
 * <code>bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictLocalServiceImpl</code> and
 ...
 * @generated
 */
public class dgfLocSubdistrictLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static dgfLocSubdistrict adddgfLocSubdistrict(
		dgfLocSubdistrict dgfLocSubdistrict) {

		return getService().adddgfLocSubdistrict(dgfLocSubdistrict);
	}
	 ...
	 */
	public static dgfLocSubdistrict createdgfLocSubdistrict(long id) {
		return getService().createdgfLocSubdistrict(id);
	}
	 ...
	 */
	public static dgfLocSubdistrict deletedgfLocSubdistrict(
		dgfLocSubdistrict dgfLocSubdistrict) {

		return getService().deletedgfLocSubdistrict(dgfLocSubdistrict);
	}
	 ...
	 */
	public static dgfLocSubdistrict deletedgfLocSubdistrict(long id)
		throws PortalException {

		return getService().deletedgfLocSubdistrict(id);
	}
	...
	public static dgfLocSubdistrict fetchdgfLocSubdistrict(long id) {
		return getService().fetchdgfLocSubdistrict(id);
	}
	 ...
	 * @throws PortalException if a dgf loc subdistrict with the primary key could not be found
	 */
	public static dgfLocSubdistrict getdgfLocSubdistrict(long id)
		throws PortalException {

		return getService().getdgfLocSubdistrict(id);
	}
	 ...
	 */
	public static List<dgfLocSubdistrict> getdgfLocSubdistricts(
		int start, int end) {

		return getService().getdgfLocSubdistricts(start, end);
	}
	 ...
	 */
	public static int getdgfLocSubdistrictsCount() {
		return getService().getdgfLocSubdistrictsCount();
	}

	public static List<dgfLocSubdistrict> getdisWiseSubDis(long disId) {
		return getService().getdisWiseSubDis(disId);
	}
	 ...
	 */
	public static dgfLocSubdistrict updatedgfLocSubdistrict(
		dgfLocSubdistrict dgfLocSubdistrict) {

		return getService().updatedgfLocSubdistrict(dgfLocSubdistrict);
	}

	public static dgfLocSubdistrictLocalService getService() {
		return _service;
	}

	private static volatile dgfLocSubdistrictLocalService _service;
