...
/**
 * Provides the local service interface for DgfDistributionSchedules. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DgfDistributionSchedulesLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DgfDistributionSchedulesLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfDistributionSchedulesLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf distribution schedules local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DgfDistributionSchedulesLocalServiceUtil} if injection and service tracking are not available.
	 */
