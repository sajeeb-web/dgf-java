...
/**
 * Provides the local service utility for DgfDlrDistributionDtls. This utility wraps
 * <code>bd.gov.dgfood.food.grain.license.service.impl.DgfDlrDistributionDtlsLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DgfDlrDistributionDtlsLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfDlrDistributionDtlsLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DgfDlrDistributionDtls addDgfDlrDistributionDtls(
		DgfDlrDistributionDtls dgfDlrDistributionDtls) {

		return getService().addDgfDlrDistributionDtls(dgfDlrDistributionDtls);
	}
	 ...
	 */
	public static DgfDlrDistributionDtls createDgfDlrDistributionDtls(long id) {
		return getService().createDgfDlrDistributionDtls(id);
	}
	 ...
	 */
	public static DgfDlrDistributionDtls deleteDgfDlrDistributionDtls(
		DgfDlrDistributionDtls dgfDlrDistributionDtls) {

		return getService().deleteDgfDlrDistributionDtls(
	 ...
	 */
	public static DgfDlrDistributionDtls deleteDgfDlrDistributionDtls(long id)
		throws PortalException {

		return getService().deleteDgfDlrDistributionDtls(id);
	}
	...
	public static DgfDlrDistributionDtls fetchDgfDlrDistributionDtls(long id) {
		return getService().fetchDgfDlrDistributionDtls(id);
	}
	 ...
	 * @throws PortalException if a dgf dlr distribution dtls with the primary key could not be found
	 */
	public static DgfDlrDistributionDtls getDgfDlrDistributionDtls(long id)
		throws PortalException {

		return getService().getDgfDlrDistributionDtls(id);
	}
	 ...
	 */
	public static List<DgfDlrDistributionDtls> getDgfDlrDistributionDtlses(
		int start, int end) {

		return getService().getDgfDlrDistributionDtlses(start, end);
	}
	 ...
	 */
	public static int getDgfDlrDistributionDtlsesCount() {
		return getService().getDgfDlrDistributionDtlsesCount();
	}
	 ...
	 */
	public static DgfDlrDistributionDtls updateDgfDlrDistributionDtls(
		DgfDlrDistributionDtls dgfDlrDistributionDtls) {

		return getService().updateDgfDlrDistributionDtls(
			dgfDlrDistributionDtls);
	}

	public static DgfDlrDistributionDtlsLocalService getService() {
		return _service;
	}

	private static volatile DgfDlrDistributionDtlsLocalService _service;
