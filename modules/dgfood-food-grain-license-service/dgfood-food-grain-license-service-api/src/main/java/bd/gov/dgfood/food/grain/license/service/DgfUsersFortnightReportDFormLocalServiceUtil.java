...
/**
 * Provides the local service utility for DgfUsersFortnightReportDForm. This utility wraps
 * <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportDFormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DgfUsersFortnightReportDFormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportDFormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DgfUsersFortnightReportDForm addDgfUsersFortnightReportDForm(
		DgfUsersFortnightReportDForm dgfUsersFortnightReportDForm) {

		return getService().addDgfUsersFortnightReportDForm(
	...
	public static DgfUsersFortnightReportDForm
		...
		return getService().createDgfUsersFortnightReportDForm(reportId);
	}
	...
	public static DgfUsersFortnightReportDForm
		...
		return getService().deleteDgfUsersFortnightReportDForm(
			dgfUsersFortnightReportDForm);
	}
	...
	public static DgfUsersFortnightReportDForm
		...
		return getService().deleteDgfUsersFortnightReportDForm(reportId);
	}
	...
	public static DgfUsersFortnightReportDForm
		...
		return getService().fetchDgfUsersFortnightReportDForm(reportId);
	}
	...
	public static DgfUsersFortnightReportDForm
		...
		return getService().getDgfUsersFortnightReportBYNidAndLicenseNo(
	 ...
	 * @throws PortalException if a dgf users fortnight report d form with the primary key could not be found
	 */
	public static DgfUsersFortnightReportDForm getDgfUsersFortnightReportDForm(
			long reportId)
		throws PortalException {

		return getService().getDgfUsersFortnightReportDForm(reportId);
	}
	...
	public static List<DgfUsersFortnightReportDForm>
		...
		return getService().getDgfUsersFortnightReportDForms(start, end);
	}
	 ...
	 */
	public static int getDgfUsersFortnightReportDFormsCount() {
		return getService().getDgfUsersFortnightReportDFormsCount();
	}
	...
	public static List<DgfUsersFortnightReportDForm>
		...
		return getService().getMatchingReportFormDByUserNationalId(nationalId);
	}
	...
	public static DgfUsersFortnightReportDForm
		...
		return getService().updateDgfUsersFortnightReportDForm(
			dgfUsersFortnightReportDForm);
	}

	public static DgfUsersFortnightReportDFormLocalService getService() {
		return _service;
	}

	private static volatile DgfUsersFortnightReportDFormLocalService _service;
