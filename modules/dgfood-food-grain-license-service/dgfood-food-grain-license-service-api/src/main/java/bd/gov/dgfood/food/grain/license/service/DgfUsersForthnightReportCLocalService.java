...
/**
 * Provides the local service interface for DgfUsersForthnightReportC. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DgfUsersForthnightReportCLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DgfUsersForthnightReportCLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersForthnightReportCLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf users forthnight report c local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DgfUsersForthnightReportCLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DgfUsersForthnightReportC addDgfUsersForthnightReportC(
	...
	public DgfUsersForthnightReportC createDgfUsersForthnightReportC(
		long reportId);
	...
	public DgfUsersForthnightReportC deleteDgfUsersForthnightReportC(
		DgfUsersForthnightReportC dgfUsersForthnightReportC);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersForthnightReportC fetchDgfUsersForthnightReportC(
		long reportId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersForthnightReportC getDgfUsersForthnightReportC(long reportId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsersForthnightReportC> getDgfUsersForthnightReportCs(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DgfUsersForthnightReportC updateDgfUsersForthnightReportC(
		DgfUsersForthnightReportC dgfUsersForthnightReportC);
