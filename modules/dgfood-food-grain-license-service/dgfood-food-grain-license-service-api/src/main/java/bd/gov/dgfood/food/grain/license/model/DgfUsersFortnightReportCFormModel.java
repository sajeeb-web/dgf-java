...
/**
 * The base model interface for the DgfUsersFortnightReportCForm service. Represents a row in the &quot;dgf_users_fortnightreport_c&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation <code>bd.gov.dgfood.food.grain.license.model.impl.DgfUsersFortnightReportCFormModelImpl</code> exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in <code>bd.gov.dgfood.food.grain.license.model.impl.DgfUsersFortnightReportCFormImpl</code>.
 * </p>
 *
 ...
 */
@ProviderType
public interface DgfUsersFortnightReportCFormModel
	extends BaseModel<DgfUsersFortnightReportCForm> {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a dgf users fortnight report c form model instance should use the {@link DgfUsersFortnightReportCForm} interface instead.
	 */
