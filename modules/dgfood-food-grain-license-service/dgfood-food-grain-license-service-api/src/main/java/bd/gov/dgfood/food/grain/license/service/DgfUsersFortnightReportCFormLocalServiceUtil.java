...
/**
 * Provides the local service utility for DgfUsersFortnightReportCForm. This utility wraps
 * <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportCFormLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DgfUsersFortnightReportCFormLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportCFormLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DgfUsersFortnightReportCForm addDgfUsersFortnightReportCForm(
		DgfUsersFortnightReportCForm dgfUsersFortnightReportCForm) {

		return getService().addDgfUsersFortnightReportCForm(
	...
	public static DgfUsersFortnightReportCForm
		...
		return getService().createDgfUsersFortnightReportCForm(reportId);
	}
	...
	public static java.util.Date dateMaker(String dateStr) {
		return getService().dateMaker(dateStr);
	}
	...
	public static DgfUsersFortnightReportCForm
		...
		return getService().deleteDgfUsersFortnightReportCForm(
			dgfUsersFortnightReportCForm);
	}
	...
	public static DgfUsersFortnightReportCForm
		...
		return getService().deleteDgfUsersFortnightReportCForm(reportId);
	}
	...
	public static DgfUsersFortnightReportCForm
		...
		return getService().fetchDgfUsersFortnightReportCForm(reportId);
	}
	...
	public static List<DgfUsersFortnightReportCForm> getAllDataUnderUCF(
		long userId, String usernationalId) {

		return getService().getAllDataUnderUCF(userId, usernationalId);
	}
	 ...
	 * @throws PortalException if a dgf users fortnight report c form with the primary key could not be found
	 */
	public static DgfUsersFortnightReportCForm getDgfUsersFortnightReportCForm(
			long reportId)
		throws PortalException {

		return getService().getDgfUsersFortnightReportCForm(reportId);
	}

	public static DgfUsersFortnightReportCForm
		getDgfUsersFortnightReportCFormByNationalId(String nationalId) {

		return getService().getDgfUsersFortnightReportCFormByNationalId(
			nationalId);
	}
	...
	public static DgfUsersFortnightReportCForm
		...
		return getService().getDgfUsersFortnightReportCFormByNidAndLicenseNo(
	...
	public static List<DgfUsersFortnightReportCForm>
		...
		return getService().getDgfUsersFortnightReportCForms(start, end);
	}
	 ...
	 */
	public static int getDgfUsersFortnightReportCFormsCount() {
		return getService().getDgfUsersFortnightReportCFormsCount();
	}
	...
	public static List<DgfUsersFortnightReportCForm>
		...
		return getService().getMatchingReportsByUserNationalId(nationalId);
	}
	...
	public static List<bd.gov.dgfood.food.grain.license.model.dgfLocUnion>
		getUnionNameByUpzillaId(long subdistrictId) {

		return getService().getUnionNameByUpzillaId(subdistrictId);
	}
	...
	public static DgfUsersFortnightReportCForm
		...
		return getService().updateDgfUsersFortnightReportCForm(
			dgfUsersFortnightReportCForm);
	}

	public static DgfUsersFortnightReportCFormLocalService getService() {
		return _service;
	}

	private static volatile DgfUsersFortnightReportCFormLocalService _service;
