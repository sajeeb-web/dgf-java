...
/**
 * Provides the local service interface for DgfUsersDtls. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DgfUsersDtlsLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DgfUsersDtlsLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersDtlsLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf users dtls local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DgfUsersDtlsLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DgfUsersDtls addDgfUsersDtls(DgfUsersDtls dgfUsersDtls);
	...
	public DgfUsersDtls createDgfUsersDtls(long userDetailsId);
	...
	public DgfUsersDtls deleteDgfUsersDtls(DgfUsersDtls dgfUsersDtls);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DgfUsersDtls deleteDgfUsersDtls(long userDetailsId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersDtls fetchDgfUsersDtls(long userDetailsId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersDtls getDgfUsersDtls(long userDetailsId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersDtls getDgfUsersDtlsByNationalId(long nationalId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsersDtls> getDgfUsersDtlses(int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DgfUsersDtls updateDgfUsersDtls(DgfUsersDtls dgfUsersDtls);
