...
public interface DgfUsersLocalService
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsers> getDgfAcfUsersByDistrict(
			long districtId, long companyId)
		throws NoSuchDgfUsersException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsers> getDgfCcdrUsersByUpazila(
			long upazilaId, long companyId)
		throws NoSuchDgfUsersException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsers> getDgfDcfUsersByDistrict(
			long districtId, long companyId)
		throws NoSuchDgfUsersException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsers> getDgfRcfUsersByUpazila(
			long upazilaId, long companyId)
		throws NoSuchDgfUsersException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsers> getDgfUcfUsersByDistrict(
			long upazilaId, long companyId)
		throws NoSuchDgfUsersException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsers getDgfUsersByNid(String nationalId)
		throws NoSuchDgfUsersException;
