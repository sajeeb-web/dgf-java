...
/**
 * Provides the local service utility for dgfLocUnion. This utility wraps
 * <code>bd.gov.dgfood.food.grain.license.service.impl.dgfLocUnionLocalServiceImpl</code> and
 ...
 * @generated
 */
public class dgfLocUnionLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.dgfLocUnionLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static dgfLocUnion adddgfLocUnion(dgfLocUnion dgfLocUnion) {
		return getService().adddgfLocUnion(dgfLocUnion);
	}
	 ...
	 */
	public static dgfLocUnion createdgfLocUnion(long id) {
		return getService().createdgfLocUnion(id);
	}
	 ...
	 */
	public static dgfLocUnion deletedgfLocUnion(dgfLocUnion dgfLocUnion) {
		return getService().deletedgfLocUnion(dgfLocUnion);
	}
	 ...
	 */
	public static dgfLocUnion deletedgfLocUnion(long id)
		throws PortalException {

		return getService().deletedgfLocUnion(id);
	}
	...
	public static dgfLocUnion fetchdgfLocUnion(long id) {
		return getService().fetchdgfLocUnion(id);
	}
	 ...
	 * @throws PortalException if a dgf loc union with the primary key could not be found
	 */
	public static dgfLocUnion getdgfLocUnion(long id) throws PortalException {
		return getService().getdgfLocUnion(id);
	}
	 ...
	 */
	public static List<dgfLocUnion> getdgfLocUnions(int start, int end) {
		return getService().getdgfLocUnions(start, end);
	}
	 ...
	 */
	public static int getdgfLocUnionsCount() {
		return getService().getdgfLocUnionsCount();
	}
	...
	public static List<dgfLocUnion> getsubDisWiseUn(long subDisId) {
		return getService().getsubDisWiseUn(subDisId);
	}
	 ...
	 */
	public static dgfLocUnion updatedgfLocUnion(dgfLocUnion dgfLocUnion) {
		return getService().updatedgfLocUnion(dgfLocUnion);
	}

	public static dgfLocUnionLocalService getService() {
		return _service;
	}

	private static volatile dgfLocUnionLocalService _service;
