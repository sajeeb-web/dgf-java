...
/**
 * Provides the local service interface for DgfUsersForthnightReportD. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DgfUsersForthnightReportDLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DgfUsersForthnightReportDLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersForthnightReportDLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf users forthnight report d local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DgfUsersForthnightReportDLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public DgfUsersForthnightReportD addDgfUsersForthnightReportD(
	...
	public DgfUsersForthnightReportD createDgfUsersForthnightReportD(
		long reportId);
	...
	public DgfUsersForthnightReportD deleteDgfUsersForthnightReportD(
		DgfUsersForthnightReportD dgfUsersForthnightReportD);
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersForthnightReportD fetchDgfUsersForthnightReportD(
		long reportId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DgfUsersForthnightReportD getDgfUsersForthnightReportD(long reportId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<DgfUsersForthnightReportD> getDgfUsersForthnightReportDs(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DgfUsersForthnightReportD updateDgfUsersForthnightReportD(
		DgfUsersForthnightReportD dgfUsersForthnightReportD);
