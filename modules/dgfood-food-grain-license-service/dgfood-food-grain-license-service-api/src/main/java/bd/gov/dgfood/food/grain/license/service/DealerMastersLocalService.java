...
/**
 * Provides the local service interface for DealerMasters. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DealerMastersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DealerMastersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DealerMastersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dealer masters local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DealerMastersLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DealerMasters getDealerMastersByMobileNo(String dealerMobileNo)
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DealerMasters getDealerMastersByNidAndMobile(
			String nationalId, String mobileNo)
		throws NoSuchDealerMastersException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public DealerMasters getDealerMastersBySecondNidAndMobile(
