...
/**
 * Provides the local service utility for DgfUsersForthnightReportD. This utility wraps
 * <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersForthnightReportDLocalServiceImpl</code> and
 ...
 * @generated
 */
public class DgfUsersForthnightReportDLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfUsersForthnightReportDLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static DgfUsersForthnightReportD addDgfUsersForthnightReportD(
		DgfUsersForthnightReportD dgfUsersForthnightReportD) {

		return getService().addDgfUsersForthnightReportD(
	 ...
	 */
	public static DgfUsersForthnightReportD createDgfUsersForthnightReportD(
		long reportId) {

		return getService().createDgfUsersForthnightReportD(reportId);
	}
	 ...
	 */
	public static DgfUsersForthnightReportD deleteDgfUsersForthnightReportD(
		DgfUsersForthnightReportD dgfUsersForthnightReportD) {

		return getService().deleteDgfUsersForthnightReportD(
			dgfUsersForthnightReportD);
	}
	...
	public static DgfUsersForthnightReportD deleteDgfUsersForthnightReportD(
		...
		return getService().deleteDgfUsersForthnightReportD(reportId);
	}
	...
	public static DgfUsersForthnightReportD fetchDgfUsersForthnightReportD(
		long reportId) {

		return getService().fetchDgfUsersForthnightReportD(reportId);
	}
	 ...
	 * @throws PortalException if a dgf users forthnight report d with the primary key could not be found
	 */
	public static DgfUsersForthnightReportD getDgfUsersForthnightReportD(
			long reportId)
		throws PortalException {

		return getService().getDgfUsersForthnightReportD(reportId);
	}
	 ...
	 */
	public static List<DgfUsersForthnightReportD> getDgfUsersForthnightReportDs(
		int start, int end) {

		return getService().getDgfUsersForthnightReportDs(start, end);
	}
	 ...
	 */
	public static int getDgfUsersForthnightReportDsCount() {
		return getService().getDgfUsersForthnightReportDsCount();
	}
	 ...
	 */
	public static DgfUsersForthnightReportD updateDgfUsersForthnightReportD(
		DgfUsersForthnightReportD dgfUsersForthnightReportD) {

		return getService().updateDgfUsersForthnightReportD(
			dgfUsersForthnightReportD);
	}

	public static DgfUsersForthnightReportDLocalService getService() {
		return _service;
	}

	private static volatile DgfUsersForthnightReportDLocalService _service;
