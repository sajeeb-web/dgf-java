...
/**
 * Provides the local service interface for DgfFglLicenseNo. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see DgfFglLicenseNoLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface DgfFglLicenseNoLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.DgfFglLicenseNoLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf fgl license no local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link DgfFglLicenseNoLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public List<DgfFglLicenseNo> findAllOrderedByIdDesc()
