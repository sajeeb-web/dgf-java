...
/**
 * Provides the local service interface for dgfLocSubdistrict. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see dgfLocSubdistrictLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface dgfLocSubdistrictLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the dgf loc subdistrict local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link dgfLocSubdistrictLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<dgfLocSubdistrict> getdisWiseSubDis(long disId);
