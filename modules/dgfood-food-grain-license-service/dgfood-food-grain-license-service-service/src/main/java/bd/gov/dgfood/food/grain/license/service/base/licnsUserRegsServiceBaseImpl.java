...
import bd.gov.dgfood.food.grain.license.service.licnsUserRegsService;
...
/**
 * Provides the base implementation for the licns user regs remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.licnsUserRegsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.licnsUserRegsServiceImpl
 * @generated
 */
public abstract class licnsUserRegsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, licnsUserRegsService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>licnsUserRegsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>licnsUserRegsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			licnsUserRegsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		licnsUserRegsService = (licnsUserRegsService)aopProxy;

		_setServiceUtilService(licnsUserRegsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return licnsUserRegsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = licnsUserRegsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, licnsUserRegsService);
		}
	...
	@Reference
	protected bd.gov.dgfood.food.grain.license.service.licnsUserRegsLocalService
		licnsUserRegsLocalService;

	protected licnsUserRegsService licnsUserRegsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		licnsUserRegsServiceBaseImpl.class);
