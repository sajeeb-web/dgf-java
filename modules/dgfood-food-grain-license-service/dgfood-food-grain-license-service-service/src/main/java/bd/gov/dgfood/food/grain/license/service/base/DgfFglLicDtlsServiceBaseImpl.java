...
import bd.gov.dgfood.food.grain.license.service.DgfFglLicDtlsService;
...
/**
 * Provides the base implementation for the dgf fgl lic dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfFglLicDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfFglLicDtlsServiceImpl
 * @generated
 */
public abstract class DgfFglLicDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfFglLicDtlsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfFglLicDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfFglLicDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfFglLicDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfFglLicDtlsService = (DgfFglLicDtlsService)aopProxy;

		_setServiceUtilService(dgfFglLicDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfFglLicDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfFglLicDtlsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfFglLicDtlsService);
		}
	...
	@Reference
	protected bd.gov.dgfood.food.grain.license.service.DgfFglLicDtlsLocalService
		dgfFglLicDtlsLocalService;

	protected DgfFglLicDtlsService dgfFglLicDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfFglLicDtlsServiceBaseImpl.class);
