...
import bd.gov.dgfood.food.grain.license.service.DgfBnkChllnDtlsService;
import bd.gov.dgfood.food.grain.license.service.DgfBnkChllnDtlsServiceUtil;
...
/**
 * Provides the base implementation for the dgf bnk chlln dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfBnkChllnDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfBnkChllnDtlsServiceImpl
 * @generated
 */
public abstract class DgfBnkChllnDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfBnkChllnDtlsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfBnkChllnDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfBnkChllnDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfBnkChllnDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfBnkChllnDtlsService = (DgfBnkChllnDtlsService)aopProxy;

		_setServiceUtilService(dgfBnkChllnDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfBnkChllnDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfBnkChllnDtlsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfBnkChllnDtlsService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfBnkChllnDtlsLocalService
			dgfBnkChllnDtlsLocalService;

	protected DgfBnkChllnDtlsService dgfBnkChllnDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfBnkChllnDtlsServiceBaseImpl.class);
