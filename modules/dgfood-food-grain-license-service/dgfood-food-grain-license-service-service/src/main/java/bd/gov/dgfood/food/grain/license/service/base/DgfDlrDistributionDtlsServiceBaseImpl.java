...
import bd.gov.dgfood.food.grain.license.service.DgfDlrDistributionDtlsService;
import bd.gov.dgfood.food.grain.license.service.DgfDlrDistributionDtlsServiceUtil;
...
/**
 * Provides the base implementation for the dgf dlr distribution dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfDlrDistributionDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfDlrDistributionDtlsServiceImpl
 * @generated
 */
public abstract class DgfDlrDistributionDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfDlrDistributionDtlsService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfDlrDistributionDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfDlrDistributionDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfDlrDistributionDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfDlrDistributionDtlsService = (DgfDlrDistributionDtlsService)aopProxy;

		_setServiceUtilService(dgfDlrDistributionDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfDlrDistributionDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				DgfDlrDistributionDtlsServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfDlrDistributionDtlsService);
		}
	...
	protected DgfDlrDistributionDtlsService dgfDlrDistributionDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfDlrDistributionDtlsServiceBaseImpl.class);
