...
import bd.gov.dgfood.food.grain.license.service.BeneficiaryOtherInfoService;
import bd.gov.dgfood.food.grain.license.service.BeneficiaryOtherInfoServiceUtil;
...
/**
 * Provides the base implementation for the beneficiary other info remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.BeneficiaryOtherInfoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.BeneficiaryOtherInfoServiceImpl
 * @generated
 */
public abstract class BeneficiaryOtherInfoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, BeneficiaryOtherInfoService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>BeneficiaryOtherInfoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>BeneficiaryOtherInfoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			BeneficiaryOtherInfoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		beneficiaryOtherInfoService = (BeneficiaryOtherInfoService)aopProxy;

		_setServiceUtilService(beneficiaryOtherInfoService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return BeneficiaryOtherInfoService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				BeneficiaryOtherInfoServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, beneficiaryOtherInfoService);
		}
	...
	protected BeneficiaryOtherInfoService beneficiaryOtherInfoService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BeneficiaryOtherInfoServiceBaseImpl.class);
