...
import bd.gov.dgfood.food.grain.license.service.DgfDuplctLicnsReasonService;
import bd.gov.dgfood.food.grain.license.service.DgfDuplctLicnsReasonServiceUtil;
...
/**
 * Provides the base implementation for the dgf duplct licns reason remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfDuplctLicnsReasonServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfDuplctLicnsReasonServiceImpl
 * @generated
 */
public abstract class DgfDuplctLicnsReasonServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfDuplctLicnsReasonService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfDuplctLicnsReasonService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfDuplctLicnsReasonServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfDuplctLicnsReasonService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfDuplctLicnsReasonService = (DgfDuplctLicnsReasonService)aopProxy;

		_setServiceUtilService(dgfDuplctLicnsReasonService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfDuplctLicnsReasonService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				DgfDuplctLicnsReasonServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfDuplctLicnsReasonService);
		}
	...
	protected DgfDuplctLicnsReasonService dgfDuplctLicnsReasonService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfDuplctLicnsReasonServiceBaseImpl.class);
