...
import bd.gov.dgfood.food.grain.license.service.DgfDistributionSchedulesLocalService;
...
/**
 * Provides the base implementation for the dgf distribution schedules local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfDistributionSchedulesLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfDistributionSchedulesLocalServiceImpl
 * @generated
 */
public abstract class DgfDistributionSchedulesLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DgfDistributionSchedulesLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfDistributionSchedulesLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfDistributionSchedulesLocalServiceUtil</code>.
	 */
	...
	@Override
	public DgfDistributionSchedules addDgfDistributionSchedules(
		DgfDistributionSchedules dgfDistributionSchedules) {

		dgfDistributionSchedules.setNew(true);

		return dgfDistributionSchedulesPersistence.update(
	...
	public DgfDistributionSchedules createDgfDistributionSchedules(String id) {
		return dgfDistributionSchedulesPersistence.create(id);
	}
	...
	@Override
	public DgfDistributionSchedules deleteDgfDistributionSchedules(String id)
		throws PortalException {

		return dgfDistributionSchedulesPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DgfDistributionSchedules deleteDgfDistributionSchedules(
		DgfDistributionSchedules dgfDistributionSchedules) {

		return dgfDistributionSchedulesPersistence.remove(
			dgfDistributionSchedules);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfDistributionSchedulesPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DgfDistributionSchedules.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfDistributionSchedulesPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfDistributionSchedulesPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public DgfDistributionSchedules fetchDgfDistributionSchedules(String id) {
		return dgfDistributionSchedulesPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DgfDistributionSchedules getDgfDistributionSchedules(String id)
		throws PortalException {

		return dgfDistributionSchedulesPersistence.findByPrimaryKey(id);
	}
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfDistributionSchedulesPersistence.create(
			(String)primaryKeyObj);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DgfDistributionSchedulesLocalServiceImpl#deleteDgfDistributionSchedules(DgfDistributionSchedules) to avoid orphaned data");
		}

		return dgfDistributionSchedulesLocalService.
			deleteDgfDistributionSchedules(
				(DgfDistributionSchedules)persistedModel);
	}

	@Override
	public BasePersistence<DgfDistributionSchedules> getBasePersistence() {
		return dgfDistributionSchedulesPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfDistributionSchedulesPersistence.findByPrimaryKey(
			primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DgfDistributionSchedules> getDgfDistributionScheduleses(
		int start, int end) {

		return dgfDistributionSchedulesPersistence.findAll(start, end);
	}
	...
	public int getDgfDistributionSchedulesesCount() {
		return dgfDistributionSchedulesPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DgfDistributionSchedules updateDgfDistributionSchedules(
		DgfDistributionSchedules dgfDistributionSchedules) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfDistributionSchedulesLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfDistributionSchedulesLocalService =
			(DgfDistributionSchedulesLocalService)aopProxy;

		_setLocalServiceUtilService(dgfDistributionSchedulesLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfDistributionSchedulesLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				dgfDistributionSchedulesPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DgfDistributionSchedulesLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfDistributionSchedulesLocalService);
		}
	...
	protected DgfDistributionSchedulesLocalService
		dgfDistributionSchedulesLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfDistributionSchedulesLocalServiceBaseImpl.class);
