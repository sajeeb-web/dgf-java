...
import bd.gov.dgfood.food.grain.license.service.dgfLocDistrictService;
...
/**
 * Provides the base implementation for the dgf loc district remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.dgfLocDistrictServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.dgfLocDistrictServiceImpl
 * @generated
 */
public abstract class dgfLocDistrictServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, dgfLocDistrictService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>dgfLocDistrictService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dgfLocDistrictServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			dgfLocDistrictService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfLocDistrictService = (dgfLocDistrictService)aopProxy;

		_setServiceUtilService(dgfLocDistrictService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return dgfLocDistrictService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = dgfLocDistrictServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfLocDistrictService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.dgfLocDistrictLocalService
			dgfLocDistrictLocalService;

	protected dgfLocDistrictService dgfLocDistrictService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		dgfLocDistrictServiceBaseImpl.class);
