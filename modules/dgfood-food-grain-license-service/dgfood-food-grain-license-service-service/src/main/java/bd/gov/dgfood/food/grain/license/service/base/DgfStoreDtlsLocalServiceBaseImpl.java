...
/**
 * Provides the base implementation for the dgf store dtls local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfStoreDtlsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfStoreDtlsLocalServiceImpl
 * @generated
 */
public abstract class DgfStoreDtlsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DgfStoreDtlsLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfStoreDtlsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfStoreDtlsLocalServiceUtil</code>.
	 */
	...
	@Override
	public DgfStoreDtls addDgfStoreDtls(DgfStoreDtls dgfStoreDtls) {
		dgfStoreDtls.setNew(true);

		return dgfStoreDtlsPersistence.update(dgfStoreDtls);
	}
	...
	public DgfStoreDtls createDgfStoreDtls(long id) {
		return dgfStoreDtlsPersistence.create(id);
	}
	...
	@Override
	public DgfStoreDtls deleteDgfStoreDtls(long id) throws PortalException {
		return dgfStoreDtlsPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DgfStoreDtls deleteDgfStoreDtls(DgfStoreDtls dgfStoreDtls) {
		return dgfStoreDtlsPersistence.remove(dgfStoreDtls);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfStoreDtlsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DgfStoreDtls.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfStoreDtlsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dgfStoreDtlsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfStoreDtlsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dgfStoreDtlsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DgfStoreDtls fetchDgfStoreDtls(long id) {
		return dgfStoreDtlsPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public DgfStoreDtls getDgfStoreDtls(long id) throws PortalException {
		return dgfStoreDtlsPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dgfStoreDtlsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DgfStoreDtls.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DgfStoreDtls.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfStoreDtlsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DgfStoreDtlsLocalServiceImpl#deleteDgfStoreDtls(DgfStoreDtls) to avoid orphaned data");
		}

		return dgfStoreDtlsLocalService.deleteDgfStoreDtls(
			(DgfStoreDtls)persistedModel);
	}

	@Override
	public BasePersistence<DgfStoreDtls> getBasePersistence() {
		return dgfStoreDtlsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfStoreDtlsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DgfStoreDtls> getDgfStoreDtlses(int start, int end) {
		return dgfStoreDtlsPersistence.findAll(start, end);
	}
	...
	public int getDgfStoreDtlsesCount() {
		return dgfStoreDtlsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DgfStoreDtls updateDgfStoreDtls(DgfStoreDtls dgfStoreDtls) {
		return dgfStoreDtlsPersistence.update(dgfStoreDtls);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfStoreDtlsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfStoreDtlsLocalService = (DgfStoreDtlsLocalService)aopProxy;

		_setLocalServiceUtilService(dgfStoreDtlsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfStoreDtlsLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = DgfStoreDtlsLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfStoreDtlsLocalService);
		}
	...
	protected DgfStoreDtlsLocalService dgfStoreDtlsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfStoreDtlsLocalServiceBaseImpl.class);
