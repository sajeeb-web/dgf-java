...
import bd.gov.dgfood.food.grain.license.service.DgfDistributionSchedulesService;
import bd.gov.dgfood.food.grain.license.service.DgfDistributionSchedulesServiceUtil;
...
/**
 * Provides the base implementation for the dgf distribution schedules remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfDistributionSchedulesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfDistributionSchedulesServiceImpl
 * @generated
 */
public abstract class DgfDistributionSchedulesServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfDistributionSchedulesService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfDistributionSchedulesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfDistributionSchedulesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfDistributionSchedulesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfDistributionSchedulesService =
			(DgfDistributionSchedulesService)aopProxy;

		_setServiceUtilService(dgfDistributionSchedulesService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfDistributionSchedulesService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				DgfDistributionSchedulesServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfDistributionSchedulesService);
		}
	...
	@Reference
	protected bd.gov.dgfood.food.grain.license.service.
		DgfDistributionSchedulesLocalService
			dgfDistributionSchedulesLocalService;

	protected DgfDistributionSchedulesService dgfDistributionSchedulesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfDistributionSchedulesServiceBaseImpl.class);
