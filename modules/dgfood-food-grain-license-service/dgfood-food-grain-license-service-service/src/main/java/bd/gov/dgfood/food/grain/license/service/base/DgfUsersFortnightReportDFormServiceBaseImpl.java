...
import bd.gov.dgfood.food.grain.license.service.DgfUsersFortnightReportDFormService;
import bd.gov.dgfood.food.grain.license.service.DgfUsersFortnightReportDFormServiceUtil;
...
/**
 * Provides the base implementation for the dgf users fortnight report d form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportDFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportDFormServiceImpl
 * @generated
 */
public abstract class DgfUsersFortnightReportDFormServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfUsersFortnightReportDFormService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfUsersFortnightReportDFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfUsersFortnightReportDFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfUsersFortnightReportDFormService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfUsersFortnightReportDFormService =
			(DgfUsersFortnightReportDFormService)aopProxy;

		_setServiceUtilService(dgfUsersFortnightReportDFormService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfUsersFortnightReportDFormService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				DgfUsersFortnightReportDFormServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersFortnightReportDFormService);
		}
	...
	protected DgfUsersFortnightReportDFormService
		dgfUsersFortnightReportDFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersFortnightReportDFormServiceBaseImpl.class);
