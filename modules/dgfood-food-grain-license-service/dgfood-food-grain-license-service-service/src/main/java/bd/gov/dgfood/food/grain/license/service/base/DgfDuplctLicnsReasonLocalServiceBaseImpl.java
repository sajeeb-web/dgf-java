...
/**
 * Provides the base implementation for the dgf duplct licns reason local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfDuplctLicnsReasonLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfDuplctLicnsReasonLocalServiceImpl
 * @generated
 */
public abstract class DgfDuplctLicnsReasonLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DgfDuplctLicnsReasonLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfDuplctLicnsReasonLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfDuplctLicnsReasonLocalServiceUtil</code>.
	 */
	...
	public DgfDuplctLicnsReason addDgfDuplctLicnsReason(
		...
		return dgfDuplctLicnsReasonPersistence.update(dgfDuplctLicnsReason);
	}
	...
	public DgfDuplctLicnsReason createDgfDuplctLicnsReason(
		...
		return dgfDuplctLicnsReasonPersistence.create(duplicateLicenseReasonID);
	}
	...
	public DgfDuplctLicnsReason deleteDgfDuplctLicnsReason(
		...
		return dgfDuplctLicnsReasonPersistence.remove(duplicateLicenseReasonID);
	}
	...
	public DgfDuplctLicnsReason deleteDgfDuplctLicnsReason(
		...
		return dgfDuplctLicnsReasonPersistence.remove(dgfDuplctLicnsReason);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfDuplctLicnsReasonPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DgfDuplctLicnsReason.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfDuplctLicnsReasonPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfDuplctLicnsReasonPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public DgfDuplctLicnsReason fetchDgfDuplctLicnsReason(
		...
		return dgfDuplctLicnsReasonPersistence.fetchByPrimaryKey(
	...
	public DgfDuplctLicnsReason getDgfDuplctLicnsReason(
		...
		return dgfDuplctLicnsReasonPersistence.findByPrimaryKey(
			duplicateLicenseReasonID);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			dgfDuplctLicnsReasonLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DgfDuplctLicnsReason.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfDuplctLicnsReasonPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DgfDuplctLicnsReasonLocalServiceImpl#deleteDgfDuplctLicnsReason(DgfDuplctLicnsReason) to avoid orphaned data");
		}

		return dgfDuplctLicnsReasonLocalService.deleteDgfDuplctLicnsReason(
			(DgfDuplctLicnsReason)persistedModel);
	}

	@Override
	public BasePersistence<DgfDuplctLicnsReason> getBasePersistence() {
		return dgfDuplctLicnsReasonPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfDuplctLicnsReasonPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DgfDuplctLicnsReason> getDgfDuplctLicnsReasons(
		...
		return dgfDuplctLicnsReasonPersistence.findAll(start, end);
	}
	...
	public int getDgfDuplctLicnsReasonsCount() {
		return dgfDuplctLicnsReasonPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfDuplctLicnsReasonLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfDuplctLicnsReasonLocalService =
			(DgfDuplctLicnsReasonLocalService)aopProxy;

		_setLocalServiceUtilService(dgfDuplctLicnsReasonLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfDuplctLicnsReasonLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				dgfDuplctLicnsReasonPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DgfDuplctLicnsReasonLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfDuplctLicnsReasonLocalService);
		}
	...
	protected DgfDuplctLicnsReasonLocalService dgfDuplctLicnsReasonLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfDuplctLicnsReasonLocalServiceBaseImpl.class);
