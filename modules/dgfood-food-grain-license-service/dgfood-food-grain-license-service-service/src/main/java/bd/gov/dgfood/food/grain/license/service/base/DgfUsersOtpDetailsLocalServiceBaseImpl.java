...
/**
 * Provides the base implementation for the dgf users otp details local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersOtpDetailsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersOtpDetailsLocalServiceImpl
 * @generated
 */
public abstract class DgfUsersOtpDetailsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DgfUsersOtpDetailsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfUsersOtpDetailsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfUsersOtpDetailsLocalServiceUtil</code>.
	 */
	...
	@Override
	public DgfUsersOtpDetails addDgfUsersOtpDetails(
		DgfUsersOtpDetails dgfUsersOtpDetails) {

		dgfUsersOtpDetails.setNew(true);

		return dgfUsersOtpDetailsPersistence.update(dgfUsersOtpDetails);
	}
	...
	public DgfUsersOtpDetails createDgfUsersOtpDetails(long otpId) {
		return dgfUsersOtpDetailsPersistence.create(otpId);
	}
	...
	@Override
	public DgfUsersOtpDetails deleteDgfUsersOtpDetails(long otpId)
		throws PortalException {

		return dgfUsersOtpDetailsPersistence.remove(otpId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DgfUsersOtpDetails deleteDgfUsersOtpDetails(
		DgfUsersOtpDetails dgfUsersOtpDetails) {

		return dgfUsersOtpDetailsPersistence.remove(dgfUsersOtpDetails);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfUsersOtpDetailsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DgfUsersOtpDetails.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfUsersOtpDetailsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dgfUsersOtpDetailsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfUsersOtpDetailsPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public DgfUsersOtpDetails fetchDgfUsersOtpDetails(long otpId) {
		return dgfUsersOtpDetailsPersistence.fetchByPrimaryKey(otpId);
	}
	 ...
	 */
	@Override
	public DgfUsersOtpDetails getDgfUsersOtpDetails(long otpId)
		throws PortalException {

		return dgfUsersOtpDetailsPersistence.findByPrimaryKey(otpId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			dgfUsersOtpDetailsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DgfUsersOtpDetails.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DgfUsersOtpDetails.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfUsersOtpDetailsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DgfUsersOtpDetailsLocalServiceImpl#deleteDgfUsersOtpDetails(DgfUsersOtpDetails) to avoid orphaned data");
		}

		return dgfUsersOtpDetailsLocalService.deleteDgfUsersOtpDetails(
			(DgfUsersOtpDetails)persistedModel);
	}

	@Override
	public BasePersistence<DgfUsersOtpDetails> getBasePersistence() {
		return dgfUsersOtpDetailsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfUsersOtpDetailsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DgfUsersOtpDetails> getDgfUsersOtpDetailses(
		int start, int end) {

		return dgfUsersOtpDetailsPersistence.findAll(start, end);
	}
	...
	public int getDgfUsersOtpDetailsesCount() {
		return dgfUsersOtpDetailsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DgfUsersOtpDetails updateDgfUsersOtpDetails(
		DgfUsersOtpDetails dgfUsersOtpDetails) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfUsersOtpDetailsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfUsersOtpDetailsLocalService =
			(DgfUsersOtpDetailsLocalService)aopProxy;

		_setLocalServiceUtilService(dgfUsersOtpDetailsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfUsersOtpDetailsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				dgfUsersOtpDetailsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DgfUsersOtpDetailsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersOtpDetailsLocalService);
		}
	...
	protected DgfUsersOtpDetailsLocalService dgfUsersOtpDetailsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersOtpDetailsLocalServiceBaseImpl.class);
