...
import bd.gov.dgfood.food.grain.license.service.VerifiedBeneficiariesService;
import bd.gov.dgfood.food.grain.license.service.VerifiedBeneficiariesServiceUtil;
...
/**
 * Provides the base implementation for the verified beneficiaries remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.VerifiedBeneficiariesServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.VerifiedBeneficiariesServiceImpl
 * @generated
 */
public abstract class VerifiedBeneficiariesServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>VerifiedBeneficiariesService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>VerifiedBeneficiariesServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			VerifiedBeneficiariesService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		verifiedBeneficiariesService = (VerifiedBeneficiariesService)aopProxy;

		_setServiceUtilService(verifiedBeneficiariesService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return VerifiedBeneficiariesService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				VerifiedBeneficiariesServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, verifiedBeneficiariesService);
		}
	...
	protected VerifiedBeneficiariesService verifiedBeneficiariesService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		VerifiedBeneficiariesServiceBaseImpl.class);
