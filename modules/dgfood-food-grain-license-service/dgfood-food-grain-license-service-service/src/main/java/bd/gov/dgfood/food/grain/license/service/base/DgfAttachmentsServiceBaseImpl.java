...
import bd.gov.dgfood.food.grain.license.service.DgfAttachmentsService;
import bd.gov.dgfood.food.grain.license.service.DgfAttachmentsServiceUtil;
...
/**
 * Provides the base implementation for the dgf attachments remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfAttachmentsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfAttachmentsServiceImpl
 * @generated
 */
public abstract class DgfAttachmentsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfAttachmentsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfAttachmentsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfAttachmentsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfAttachmentsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfAttachmentsService = (DgfAttachmentsService)aopProxy;

		_setServiceUtilService(dgfAttachmentsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfAttachmentsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfAttachmentsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfAttachmentsService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfAttachmentsLocalService
			dgfAttachmentsLocalService;

	protected DgfAttachmentsService dgfAttachmentsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfAttachmentsServiceBaseImpl.class);
