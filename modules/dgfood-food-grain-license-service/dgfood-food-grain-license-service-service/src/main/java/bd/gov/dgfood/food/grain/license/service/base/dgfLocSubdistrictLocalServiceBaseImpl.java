...
/**
 * Provides the base implementation for the dgf loc subdistrict local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictLocalServiceImpl
 * @generated
 */
public abstract class dgfLocSubdistrictLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, dgfLocSubdistrictLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>dgfLocSubdistrictLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dgfLocSubdistrictLocalServiceUtil</code>.
	 */
	...
	@Override
	public dgfLocSubdistrict adddgfLocSubdistrict(
		dgfLocSubdistrict dgfLocSubdistrict) {

		dgfLocSubdistrict.setNew(true);

		return dgfLocSubdistrictPersistence.update(dgfLocSubdistrict);
	}
	...
	public dgfLocSubdistrict createdgfLocSubdistrict(long id) {
		return dgfLocSubdistrictPersistence.create(id);
	}
	...
	@Override
	public dgfLocSubdistrict deletedgfLocSubdistrict(long id)
		throws PortalException {

		return dgfLocSubdistrictPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public dgfLocSubdistrict deletedgfLocSubdistrict(
		dgfLocSubdistrict dgfLocSubdistrict) {

		return dgfLocSubdistrictPersistence.remove(dgfLocSubdistrict);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfLocSubdistrictPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			dgfLocSubdistrict.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfLocSubdistrictPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dgfLocSubdistrictPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfLocSubdistrictPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dgfLocSubdistrictPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public dgfLocSubdistrict fetchdgfLocSubdistrict(long id) {
		return dgfLocSubdistrictPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public dgfLocSubdistrict getdgfLocSubdistrict(long id)
		throws PortalException {

		return dgfLocSubdistrictPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			dgfLocSubdistrictLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(dgfLocSubdistrict.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(dgfLocSubdistrict.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfLocSubdistrictPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement dgfLocSubdistrictLocalServiceImpl#deletedgfLocSubdistrict(dgfLocSubdistrict) to avoid orphaned data");
		}

		return dgfLocSubdistrictLocalService.deletedgfLocSubdistrict(
			(dgfLocSubdistrict)persistedModel);
	}

	@Override
	public BasePersistence<dgfLocSubdistrict> getBasePersistence() {
		return dgfLocSubdistrictPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfLocSubdistrictPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<dgfLocSubdistrict> getdgfLocSubdistricts(int start, int end) {
		return dgfLocSubdistrictPersistence.findAll(start, end);
	}
	...
	public int getdgfLocSubdistrictsCount() {
		return dgfLocSubdistrictPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public dgfLocSubdistrict updatedgfLocSubdistrict(
		dgfLocSubdistrict dgfLocSubdistrict) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			dgfLocSubdistrictLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfLocSubdistrictLocalService = (dgfLocSubdistrictLocalService)aopProxy;

		_setLocalServiceUtilService(dgfLocSubdistrictLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return dgfLocSubdistrictLocalService.class.getName();
	}
	...
	protected String getModelClassName() {
		return dgfLocSubdistrict.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				dgfLocSubdistrictPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				dgfLocSubdistrictLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfLocSubdistrictLocalService);
		}
	...
	protected dgfLocSubdistrictLocalService dgfLocSubdistrictLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		dgfLocSubdistrictLocalServiceBaseImpl.class);
