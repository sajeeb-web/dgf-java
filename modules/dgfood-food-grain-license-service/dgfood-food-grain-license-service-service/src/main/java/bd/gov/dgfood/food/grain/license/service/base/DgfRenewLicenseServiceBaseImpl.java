...
import bd.gov.dgfood.food.grain.license.service.DgfRenewLicenseService;
import bd.gov.dgfood.food.grain.license.service.DgfRenewLicenseServiceUtil;
...
/**
 * Provides the base implementation for the dgf renew license remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfRenewLicenseServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfRenewLicenseServiceImpl
 * @generated
 */
public abstract class DgfRenewLicenseServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfRenewLicenseService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfRenewLicenseService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfRenewLicenseServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfRenewLicenseService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfRenewLicenseService = (DgfRenewLicenseService)aopProxy;

		_setServiceUtilService(dgfRenewLicenseService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfRenewLicenseService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfRenewLicenseServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfRenewLicenseService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfRenewLicenseLocalService
			dgfRenewLicenseLocalService;

	protected DgfRenewLicenseService dgfRenewLicenseService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfRenewLicenseServiceBaseImpl.class);
