...
import bd.gov.dgfood.food.grain.license.service.DgfUsersOtpDetailsService;
...
/**
 * Provides the base implementation for the dgf users otp details remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersOtpDetailsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersOtpDetailsServiceImpl
 * @generated
 */
public abstract class DgfUsersOtpDetailsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfUsersOtpDetailsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfUsersOtpDetailsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfUsersOtpDetailsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfUsersOtpDetailsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfUsersOtpDetailsService = (DgfUsersOtpDetailsService)aopProxy;

		_setServiceUtilService(dgfUsersOtpDetailsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfUsersOtpDetailsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfUsersOtpDetailsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersOtpDetailsService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfUsersOtpDetailsLocalService
			dgfUsersOtpDetailsLocalService;

	protected DgfUsersOtpDetailsService dgfUsersOtpDetailsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersOtpDetailsServiceBaseImpl.class);
