 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersLocalServiceImpl
 * @generated
 */
public abstract class DgfUsersLocalServiceBaseImpl
	...
	public DgfUsers createDgfUsers(long userId) {
		return dgfUsersPersistence.create(userId);
	}
	...
	@Override
	public DgfUsers deleteDgfUsers(long userId) throws PortalException {
		return dgfUsersPersistence.remove(userId);
	}
	...
	@Override
	public DgfUsers fetchDgfUsers(long userId) {
		return dgfUsersPersistence.fetchByPrimaryKey(userId);
	}
	 ...
	 */
	@Override
	public DgfUsers getDgfUsers(long userId) throws PortalException {
		return dgfUsersPersistence.findByPrimaryKey(userId);
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DgfUsersLocalServiceImpl#deleteDgfUsers(DgfUsers) to avoid orphaned data");
		}
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersLocalServiceBaseImpl.class);
