...
import bd.gov.dgfood.food.grain.license.service.DgfBussAddrDtlsService;
import bd.gov.dgfood.food.grain.license.service.DgfBussAddrDtlsServiceUtil;
...
/**
 * Provides the base implementation for the dgf buss addr dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfBussAddrDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfBussAddrDtlsServiceImpl
 * @generated
 */
public abstract class DgfBussAddrDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfBussAddrDtlsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfBussAddrDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfBussAddrDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfBussAddrDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfBussAddrDtlsService = (DgfBussAddrDtlsService)aopProxy;

		_setServiceUtilService(dgfBussAddrDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfBussAddrDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfBussAddrDtlsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfBussAddrDtlsService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfBussAddrDtlsLocalService
			dgfBussAddrDtlsLocalService;

	protected DgfBussAddrDtlsService dgfBussAddrDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfBussAddrDtlsServiceBaseImpl.class);
