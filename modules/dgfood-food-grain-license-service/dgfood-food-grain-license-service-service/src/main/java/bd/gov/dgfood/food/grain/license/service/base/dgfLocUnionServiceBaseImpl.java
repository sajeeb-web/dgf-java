...
import bd.gov.dgfood.food.grain.license.service.dgfLocUnionService;
...
/**
 * Provides the base implementation for the dgf loc union remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.dgfLocUnionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.dgfLocUnionServiceImpl
 * @generated
 */
public abstract class dgfLocUnionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, dgfLocUnionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>dgfLocUnionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dgfLocUnionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			dgfLocUnionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfLocUnionService = (dgfLocUnionService)aopProxy;

		_setServiceUtilService(dgfLocUnionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return dgfLocUnionService.class.getName();
	}
	...
	private void _setServiceUtilService(dgfLocUnionService dgfLocUnionService) {
		try {
			Field field = dgfLocUnionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfLocUnionService);
		}
	...
	@Reference
	protected bd.gov.dgfood.food.grain.license.service.dgfLocUnionLocalService
		dgfLocUnionLocalService;

	protected dgfLocUnionService dgfLocUnionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		dgfLocUnionServiceBaseImpl.class);
