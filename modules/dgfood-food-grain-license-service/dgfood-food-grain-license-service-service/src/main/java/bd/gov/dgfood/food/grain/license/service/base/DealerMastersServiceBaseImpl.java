...
import bd.gov.dgfood.food.grain.license.service.DealerMastersService;
import bd.gov.dgfood.food.grain.license.service.DealerMastersServiceUtil;
...
/**
 * Provides the base implementation for the dealer masters remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DealerMastersServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DealerMastersServiceImpl
 * @generated
 */
public abstract class DealerMastersServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DealerMastersService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DealerMastersService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DealerMastersServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DealerMastersService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dealerMastersService = (DealerMastersService)aopProxy;

		_setServiceUtilService(dealerMastersService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DealerMastersService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DealerMastersServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dealerMastersService);
		}
	...
	@Reference
	protected bd.gov.dgfood.food.grain.license.service.DealerMastersLocalService
		dealerMastersLocalService;

	protected DealerMastersService dealerMastersService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DealerMastersServiceBaseImpl.class);
