...
/**
 * Provides the base implementation for the dgf fgl product dtls local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfFglProductDtlsLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfFglProductDtlsLocalServiceImpl
 * @generated
 */
public abstract class DgfFglProductDtlsLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, DgfFglProductDtlsLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfFglProductDtlsLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfFglProductDtlsLocalServiceUtil</code>.
	 */
	...
	@Override
	public DgfFglProductDtls addDgfFglProductDtls(
		DgfFglProductDtls dgfFglProductDtls) {

		dgfFglProductDtls.setNew(true);

		return dgfFglProductDtlsPersistence.update(dgfFglProductDtls);
	}
	...
	public DgfFglProductDtls createDgfFglProductDtls(long fglProductPrimaryId) {
		return dgfFglProductDtlsPersistence.create(fglProductPrimaryId);
	}
	...
	@Override
	public DgfFglProductDtls deleteDgfFglProductDtls(long fglProductPrimaryId)
		throws PortalException {

		return dgfFglProductDtlsPersistence.remove(fglProductPrimaryId);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public DgfFglProductDtls deleteDgfFglProductDtls(
		DgfFglProductDtls dgfFglProductDtls) {

		return dgfFglProductDtlsPersistence.remove(dgfFglProductDtls);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfFglProductDtlsPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			DgfFglProductDtls.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfFglProductDtlsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dgfFglProductDtlsPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfFglProductDtlsPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dgfFglProductDtlsPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public DgfFglProductDtls fetchDgfFglProductDtls(long fglProductPrimaryId) {
		return dgfFglProductDtlsPersistence.fetchByPrimaryKey(
			fglProductPrimaryId);
	}
	 ...
	 */
	@Override
	public DgfFglProductDtls getDgfFglProductDtls(long fglProductPrimaryId)
		throws PortalException {

		return dgfFglProductDtlsPersistence.findByPrimaryKey(
			fglProductPrimaryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(
			dgfFglProductDtlsLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(DgfFglProductDtls.class);

		actionableDynamicQuery.setPrimaryKeyPropertyName("fglProductPrimaryId");
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setModelClass(DgfFglProductDtls.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfFglProductDtlsPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement DgfFglProductDtlsLocalServiceImpl#deleteDgfFglProductDtls(DgfFglProductDtls) to avoid orphaned data");
		}

		return dgfFglProductDtlsLocalService.deleteDgfFglProductDtls(
			(DgfFglProductDtls)persistedModel);
	}

	@Override
	public BasePersistence<DgfFglProductDtls> getBasePersistence() {
		return dgfFglProductDtlsPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfFglProductDtlsPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<DgfFglProductDtls> getDgfFglProductDtlses(int start, int end) {
		return dgfFglProductDtlsPersistence.findAll(start, end);
	}
	...
	public int getDgfFglProductDtlsesCount() {
		return dgfFglProductDtlsPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public DgfFglProductDtls updateDgfFglProductDtls(
		DgfFglProductDtls dgfFglProductDtls) {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfFglProductDtlsLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfFglProductDtlsLocalService = (DgfFglProductDtlsLocalService)aopProxy;

		_setLocalServiceUtilService(dgfFglProductDtlsLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfFglProductDtlsLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource =
				dgfFglProductDtlsPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				DgfFglProductDtlsLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfFglProductDtlsLocalService);
		}
	...
	protected DgfFglProductDtlsLocalService dgfFglProductDtlsLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfFglProductDtlsLocalServiceBaseImpl.class);
