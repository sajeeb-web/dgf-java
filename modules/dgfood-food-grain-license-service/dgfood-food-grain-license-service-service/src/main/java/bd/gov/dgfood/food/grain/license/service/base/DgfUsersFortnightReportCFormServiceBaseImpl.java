...
import bd.gov.dgfood.food.grain.license.service.DgfUsersFortnightReportCFormService;
import bd.gov.dgfood.food.grain.license.service.DgfUsersFortnightReportCFormServiceUtil;
...
/**
 * Provides the base implementation for the dgf users fortnight report c form remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportCFormServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersFortnightReportCFormServiceImpl
 * @generated
 */
public abstract class DgfUsersFortnightReportCFormServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfUsersFortnightReportCFormService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfUsersFortnightReportCFormService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfUsersFortnightReportCFormServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfUsersFortnightReportCFormService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfUsersFortnightReportCFormService =
			(DgfUsersFortnightReportCFormService)aopProxy;

		_setServiceUtilService(dgfUsersFortnightReportCFormService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfUsersFortnightReportCFormService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field =
				DgfUsersFortnightReportCFormServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersFortnightReportCFormService);
		}
	...
	protected DgfUsersFortnightReportCFormService
		dgfUsersFortnightReportCFormService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersFortnightReportCFormServiceBaseImpl.class);
