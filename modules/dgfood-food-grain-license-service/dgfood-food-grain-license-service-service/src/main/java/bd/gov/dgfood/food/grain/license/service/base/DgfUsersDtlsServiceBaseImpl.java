...
import bd.gov.dgfood.food.grain.license.service.DgfUsersDtlsService;
import bd.gov.dgfood.food.grain.license.service.DgfUsersDtlsServiceUtil;
...
/**
 * Provides the base implementation for the dgf users dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersDtlsServiceImpl
 * @generated
 */
public abstract class DgfUsersDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfUsersDtlsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfUsersDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfUsersDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfUsersDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfUsersDtlsService = (DgfUsersDtlsService)aopProxy;

		_setServiceUtilService(dgfUsersDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfUsersDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		DgfUsersDtlsService dgfUsersDtlsService) {

		try {
			Field field = DgfUsersDtlsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersDtlsService);
		}
	...
	@Reference
	protected bd.gov.dgfood.food.grain.license.service.DgfUsersDtlsLocalService
		dgfUsersDtlsLocalService;

	protected DgfUsersDtlsService dgfUsersDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersDtlsServiceBaseImpl.class);
