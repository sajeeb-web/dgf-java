...
import bd.gov.dgfood.food.grain.license.service.DgfUsersAddrDtlsService;
import bd.gov.dgfood.food.grain.license.service.DgfUsersAddrDtlsServiceUtil;
...
/**
 * Provides the base implementation for the dgf users addr dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfUsersAddrDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfUsersAddrDtlsServiceImpl
 * @generated
 */
public abstract class DgfUsersAddrDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfUsersAddrDtlsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfUsersAddrDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfUsersAddrDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfUsersAddrDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfUsersAddrDtlsService = (DgfUsersAddrDtlsService)aopProxy;

		_setServiceUtilService(dgfUsersAddrDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfUsersAddrDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfUsersAddrDtlsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfUsersAddrDtlsService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfUsersAddrDtlsLocalService
			dgfUsersAddrDtlsLocalService;

	protected DgfUsersAddrDtlsService dgfUsersAddrDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfUsersAddrDtlsServiceBaseImpl.class);
