...
import bd.gov.dgfood.food.grain.license.service.dgfLocDivisionService;
...
/**
 * Provides the base implementation for the dgf loc division remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.dgfLocDivisionServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.dgfLocDivisionServiceImpl
 * @generated
 */
public abstract class dgfLocDivisionServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, dgfLocDivisionService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>dgfLocDivisionService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dgfLocDivisionServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			dgfLocDivisionService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfLocDivisionService = (dgfLocDivisionService)aopProxy;

		_setServiceUtilService(dgfLocDivisionService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return dgfLocDivisionService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = dgfLocDivisionServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfLocDivisionService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.dgfLocDivisionLocalService
			dgfLocDivisionLocalService;

	protected dgfLocDivisionService dgfLocDivisionService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		dgfLocDivisionServiceBaseImpl.class);
