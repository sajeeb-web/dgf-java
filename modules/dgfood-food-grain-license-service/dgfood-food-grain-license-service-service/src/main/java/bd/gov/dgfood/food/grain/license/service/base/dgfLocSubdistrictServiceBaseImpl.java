...
import bd.gov.dgfood.food.grain.license.service.dgfLocSubdistrictService;
...
/**
 * Provides the base implementation for the dgf loc subdistrict remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.dgfLocSubdistrictServiceImpl
 * @generated
 */
public abstract class dgfLocSubdistrictServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, dgfLocSubdistrictService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>dgfLocSubdistrictService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dgfLocSubdistrictServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			dgfLocSubdistrictService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfLocSubdistrictService = (dgfLocSubdistrictService)aopProxy;

		_setServiceUtilService(dgfLocSubdistrictService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return dgfLocSubdistrictService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = dgfLocSubdistrictServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfLocSubdistrictService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.dgfLocSubdistrictLocalService
			dgfLocSubdistrictLocalService;

	protected dgfLocSubdistrictService dgfLocSubdistrictService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		dgfLocSubdistrictServiceBaseImpl.class);
