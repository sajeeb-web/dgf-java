...
import bd.gov.dgfood.food.grain.license.service.DgfFglProductDtlsService;
import bd.gov.dgfood.food.grain.license.service.DgfFglProductDtlsServiceUtil;
...
/**
 * Provides the base implementation for the dgf fgl product dtls remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.DgfFglProductDtlsServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.DgfFglProductDtlsServiceImpl
 * @generated
 */
public abstract class DgfFglProductDtlsServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, DgfFglProductDtlsService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>DgfFglProductDtlsService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>DgfFglProductDtlsServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			DgfFglProductDtlsService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		dgfFglProductDtlsService = (DgfFglProductDtlsService)aopProxy;

		_setServiceUtilService(dgfFglProductDtlsService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return DgfFglProductDtlsService.class.getName();
	}
	...
	private void _setServiceUtilService(
		...
		try {
			Field field = DgfFglProductDtlsServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfFglProductDtlsService);
		}
	...
	@Reference
	protected
		bd.gov.dgfood.food.grain.license.service.DgfFglProductDtlsLocalService
			dgfFglProductDtlsLocalService;

	protected DgfFglProductDtlsService dgfFglProductDtlsService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		DgfFglProductDtlsServiceBaseImpl.class);
