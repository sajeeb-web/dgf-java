...
/**
 * Provides the base implementation for the dgf loc division local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link bd.gov.dgfood.food.grain.license.service.impl.dgfLocDivisionLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see bd.gov.dgfood.food.grain.license.service.impl.dgfLocDivisionLocalServiceImpl
 * @generated
 */
public abstract class dgfLocDivisionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, dgfLocDivisionLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>dgfLocDivisionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>dgfLocDivisionLocalServiceUtil</code>.
	 */
	...
	@Override
	public dgfLocDivision adddgfLocDivision(dgfLocDivision dgfLocDivision) {
		dgfLocDivision.setNew(true);

		return dgfLocDivisionPersistence.update(dgfLocDivision);
	}
	...
	public dgfLocDivision createdgfLocDivision(long id) {
		return dgfLocDivisionPersistence.create(id);
	}
	...
	@Override
	public dgfLocDivision deletedgfLocDivision(long id) throws PortalException {
		return dgfLocDivisionPersistence.remove(id);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public dgfLocDivision deletedgfLocDivision(dgfLocDivision dgfLocDivision) {
		return dgfLocDivisionPersistence.remove(dgfLocDivision);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return dgfLocDivisionPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			dgfLocDivision.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return dgfLocDivisionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return dgfLocDivisionPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return dgfLocDivisionPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return dgfLocDivisionPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public dgfLocDivision fetchdgfLocDivision(long id) {
		return dgfLocDivisionPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 */
	@Override
	public dgfLocDivision getdgfLocDivision(long id) throws PortalException {
		return dgfLocDivisionPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(dgfLocDivisionLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(dgfLocDivision.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(
			dgfLocDivisionLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(dgfLocDivision.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return dgfLocDivisionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		if (_log.isWarnEnabled()) {
			_log.warn(
				"Implement dgfLocDivisionLocalServiceImpl#deletedgfLocDivision(dgfLocDivision) to avoid orphaned data");
		}

		return dgfLocDivisionLocalService.deletedgfLocDivision(
			(dgfLocDivision)persistedModel);
	}

	@Override
	public BasePersistence<dgfLocDivision> getBasePersistence() {
		return dgfLocDivisionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return dgfLocDivisionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<dgfLocDivision> getdgfLocDivisions(int start, int end) {
		return dgfLocDivisionPersistence.findAll(start, end);
	}
	...
	public int getdgfLocDivisionsCount() {
		return dgfLocDivisionPersistence.countAll();
	}
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public dgfLocDivision updatedgfLocDivision(dgfLocDivision dgfLocDivision) {
		return dgfLocDivisionPersistence.update(dgfLocDivision);
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			dgfLocDivisionLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		dgfLocDivisionLocalService = (dgfLocDivisionLocalService)aopProxy;

		_setLocalServiceUtilService(dgfLocDivisionLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return dgfLocDivisionLocalService.class.getName();
	}
	...
	protected void runSQL(String sql) {
		try {
			DataSource dataSource = dgfLocDivisionPersistence.getDataSource();
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = dgfLocDivisionLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, dgfLocDivisionLocalService);
		}
	...
	protected dgfLocDivisionLocalService dgfLocDivisionLocalService;
	...
	private static final Log _log = LogFactoryUtil.getLog(
		dgfLocDivisionLocalServiceBaseImpl.class);
